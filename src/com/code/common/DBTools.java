...
//    private static String password = "bnms3";
    private static String dirverClassName = Config.getProperty("dirverClassName");
    public static String url = Config.getProperty("databaseURL");
    private static String user = Config.getProperty("databaseUserName");
    private static String password = Config.getProperty("databasePasswd");
