...
import com.code.test.unicom.numAssign.NumAssignPage;
 ...
 */
public class NumAssignTest extends TestCase2 {
    @Parameters({"node"})
    public NumAssignTest(String node) {
        super(node);
    }
    ...
    @Test(description = "号码下发")
    public void numAssignTest(){
        mainPage.menuPage.selectMenu("库存管理","号码下发");
