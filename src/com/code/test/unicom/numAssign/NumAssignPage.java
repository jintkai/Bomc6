package com.code.test.unicom.numAssign;
...
public class NumAssignPage extends Page {
    ...
    @FindBy(how=How.ID,using = "ztree_1_switch")
    WebElement ztree_1_switch;
    @FindBy(how=How.ID,using = "ztree_1")
    WebElement ztree_1;
    @FindBy(how=How.ID,using = "srcStock_name")
    WebElement srcStock_name;
    public String numAssegn(Map<String,String> map){
        ...
        if( tools.getMapValue(map,"源机构").contains("区县")) {

            tools.click(srcStock_name);

            //tools.click(group_tree_1_switch);
            tools.sleep(3000);
            tools.click(ztree_1_switch);
            tools.sleep(2000);
            List<WebElement> treeMenus = tools.findElements(ztree_1, By.tagName("a"));
            ...
            e=tools.findElements(group_tree_1_ul,By.tagName("a")).get(i);*/
                String s = e.getText();
                if (s.equals(tools.getMapValue(map, "源机构"))) {
                    //tools.sleep(3000);
                /*group_tree_1_ul=tools.findBy(tools.getDriver(),By.id("group_tree_1_ul"));
                e=tools.findElements(group_tree_1_ul,By.tagName("a")).get(i);*/
                    tools.click(e);
